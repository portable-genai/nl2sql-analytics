...
read
    ...
    bind_profile == local AND profile chosen AND NL2SQL_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/ask`` with a real escalated decision written to the
review outbox.
...
from nl2sql_analytics.adapters.local.identity import (
    LocalIdentityAdapter,
)
from nl2sql_analytics.adapters.onprem.identity import (
