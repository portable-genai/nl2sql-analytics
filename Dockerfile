# NL2SQL Semantic Analyst (H1) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    NL2SQL_PROFILE=gcp \
    NL2SQL_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m nl2sql_analytics.managed_readiness && exec uvicorn nl2sql_analytics.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
